    ...
    const textField = document.getElementById('textField');
     ...
     // Add an onChange event to the rating select list
     ratingSelect.addEventListener('change', function () {
        const selectedRating = parseInt(ratingSelect.value);
    
        // If the selected rating is 1 or higher, show the checkbox
        if (selectedRating >= 1) {
    ...
    // Add an onChange event to the enableTextCheckbox
    ...
    form.addEventListener('submit', (e) =>  {
        ...
        tdstreetAddress1Node.innerHTML = document.getElementById("streetAddress1").value ;
        ...
        // Manually clear the "Rating" dropdown
        const ratingSelect = document.getElementById('rating');
        ratingSelect.selectedIndex = -1;

        // Manually clear the rating checkbox
         const ratingCheckbox = document.getElementById('enableText');
         ratingCheckbox.checked = false;

        // Hide the "Rating Comment" input field when "Rate Us" is cleared
        const textFieldContainer = document.getElementById('text-field-container');
        textFieldContainer.style.display = 'none';


        // Manually clear the "textField" input field
        const textField = document.getElementById('textField');
        textField.value = '';
